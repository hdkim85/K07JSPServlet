...
<body>
	...
	/* 
	전송방식 get/post에 상관없이 geParameter("파라미터명") 메소드로
	폼값을 받을수있다. 만약 값이 입력되지 앟았따면 길이가 0인 String객체를
	...
	*/
	...
	if(!(name==null || name.equals(""))){
		...
		아래와 같이 사용할 수 있다. 또는 문자열을 연결하여 사용할수도
		있다.
		*/
		out.println("<script>");
	...
	*/
	...
	웹브라우저에 출력할때는 특수기호를 <br>태그로 변환 후 출력해야한다.
	*/
	String self_intro = 
	...
	getParameterNames() : 폼값의 이름을 한꺼번에 받을때 사용하는
		request 내장객체의 메소드로 반환타입은 Enumeratrion형이다.
