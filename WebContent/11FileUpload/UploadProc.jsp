...
try{
	/* 
	1~4번까지의 준비한 인자를 이용하여 MultipartRequest객체를 생성한다.
	개체가 정상적으로 생성되면 파일업로드는 완료된다.
	...
	*/
	...
	request.getRequestDispatcher("FileUploadMail.jsp").forward(request, response);
}
...
<body>
	...
	<ul>
		...
		<li>이미지표현:
		<img src="../Upload/<%=mr.getFilesystemName("chumFile1") %>" width="200"/>
		</li>
	</ul>
	...
	<li>원본파일명:
		...
		<li>이미지표현:
		<img src="../Upload/<%=mr.getFilesystemName("chumFile2") %>" width="200"/>
		</li>
