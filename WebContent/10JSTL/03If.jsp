...
<body>
	<!-- 
		...
		- else문이 없기 때문에 조건이 여러개일 때는 표현이 어렵다.
	...
	<c:if test="${not empty param.user }">
		...
		<!-- 
			...
			가지게 되는 구조로 작성되었다. 즉 loginResult가 true값으로
			설정된다면 두번째 if문에서는 false의 조건으로 바뀌게된다.
		 -->
