...
<body>
	...
	<!-- 
	EL로 영역의 속성을 읽어올 떄는 XXXScope를 생략하면 가장 좁은
	...
	컬렉션의 값을 설정할 떄 사용하는 속성이다.
	target : 변수갑승ㄹ 지정하는 속성. 반드시 EL, 표현식만 가능
	...
	<c:set var = "defaultMember" value="<%= new MemberDTO() %>"
			scope = "request"/>
	<!-- 2. 생성된 변수의 멤버변수값 지정 -->			
	<!-- 객체의 멤버변수별로 DTO객체에 저장(id, pass, name), target속성 이용 -->
