...
<body>
	<!-- 
		어플리케이션 영역에 저장된 속성은 페이지이동, 전달이 되더라도
		그 영역에 공유되고, 웹브라우저를 종료했다가 다시 실행하더라도
		그 영역이 공유된다. 즉 한번 저장됨녀 웹서버가 셧다운(종료)될때까지는
		속성값이 유지된다. 
	 -->
	...
	<h3>맵 계열의 컬렉션(application 영역)</h3>
	...
	<h4>forward되니 페이지까지 영역이 공유된다.</h4>
