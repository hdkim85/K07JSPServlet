...
<%--
	선언부(Declaration) : 스크립트렛이나 표현식에서 사용할
		...
		경우가 많으므로 src(자바영역 : src폴더)을 많이 사용한다.
 --%>
...
<body>
	...
	표현식(Expression) : 변수를 웹브라우저상에 출력할때 사용한다.
		JS의 document.writer()와 동일한 역할을 한다.
		주의할 점은 문장 끝에 ;(세미콜론)을 생략해야 하는것이다.
		사용법 : <%= 변수
	 --%>
